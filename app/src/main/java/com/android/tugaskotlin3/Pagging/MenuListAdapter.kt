...
import com.Pagging.ListFooterViewHolder
import com.Pagging.State

class MenuListAdapter ( private val retry: () -> Unit)
    : PagedListAdapter<Menu, RecyclerView.ViewHolder>
    (NewsDiffCallback){
    ...
    companion object{
        val NewsDiffCallback = object : DiffUtil.ItemCallback<Menu>(){
            override fun areItemsTheSame (oldItem: Menu, newItem: Menu) : Boolean{
                return oldItem.name_product == newItem.name_product
            }
